  ...
  return (
    <section className="space-y-5">
      <header className="space-y-1 px-1">
        <h1 className="text-[28px] font-semibold tracking-tight text-slate-900">หมวดหมู่สินค้า</h1>
        <p className="text-sm text-slate-500">
          จัดการหมวดหมู่เพื่อจัดกลุ่มสินค้าในร้าน เช่น อาหาร เครื่องดื่ม ขนม
        </p>
      </header>
