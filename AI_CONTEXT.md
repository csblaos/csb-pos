...
- i18n foundation รอบแรกถูกวางแล้วสำหรับ `lo / th / en` โดย default language ของระบบตอนนี้คือ `th`
- preference ภาษาเก็บที่ `users.preferred_language` และถูก hydrate เข้า session/app shell แล้ว
- หน้า `/settings/language` ใช้เปลี่ยนภาษาได้แล้ว; scope ที่แปลจริงตอนนี้คือ `app shell + top nav + bottom nav + settings language + dashboard + orders + stock + products + reports page + auth/onboarding high-traffic flow + system-admin page shell/high-traffic summary + users-management deep operator flow + stores-management deep operator flow + stores/superadmin stores page-shell navigation` โดยทั้ง `manage flow` และ `create-order flow` ใน `/orders/new` ใช้ translator กลางแล้ว, stock operator flow ใน [components/app/stock-recording-form.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-recording-form.tsx) ถูกเก็บ deep strings แล้ว, purchase workspace ใน [components/app/purchase-order-list.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/purchase-order-list.tsx) ถูกแปลเพิ่มแล้วสำหรับ pending-rate queue, month-end bulk panel, create wizard + close-confirm modal, workspace summary cards, operations list cards/status timeline/progress, และ `PODetailSheet` ชุด action/summary/timeline/edit form หลัก รวม validation/toasts/PDF feedback ของ detail sheet; ส่วนที่ยังเหลือหลักๆ เป็น shortcut/default helper copy กับ audit ปลายทางของ AP supplier/export surfaces มากกว่าก้อน flow หลักที่ผู้ใช้กดทุกวัน, products workspace ใน [app/(app)/products/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/products/page.tsx) กับ [components/app/products-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/products-management.tsx) ถูกเก็บครบถึง deep form/detail flow แล้ว ทั้ง image picker/help text, SKU/barcode/category/variant forms, matrix builder, conversions, unsaved/deactivate confirms, detail tabs, cost editor, cost tracking summary, scanner toasts, barcode print/copy flow, และ locale-aware price/date formatting, [app/(app)/reports/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/reports/page.tsx) ถูกแปลทั้ง analytics header, KPI labels/hints, section titles, COD/AP/FX labels, empty states, และ locale-aware number formatting แล้ว, auth/onboarding flow ใน [app/(auth)/login/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(auth)/login/page.tsx), [app/(auth)/signup/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(auth)/signup/page.tsx), [app/(auth)/account-status/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(auth)/account-status/page.tsx), [components/app/login-form.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/login-form.tsx), [components/app/signup-form.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/signup-form.tsx), และ [components/app/onboarding-wizard.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/onboarding-wizard.tsx) ใช้ `auth.*` translation keys แล้ว รวมทั้ง store-type cards และ channel status copy, superadmin pages [app/(app)/settings/superadmin/overview/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/overview/page.tsx), [app/(app)/settings/superadmin/global-config/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/global-config/page.tsx), [app/(app)/settings/superadmin/users/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/users/page.tsx), และ [app/(app)/settings/superadmin/stores/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/stores/page.tsx) ใช้ `superadmin.*` translation keys สำหรับ page shell, KPI labels, summaries, navigation, และ no-permission states แล้ว, [components/app/users-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/users-management.tsx) ใช้ `superadmin.users.*` keys แล้วสำหรับ summary/list, create member sheet, add-existing flow, edit member sheet, branch access, reset password, validation, และ toasts ทั้งใน [app/(app)/settings/users/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/users/page.tsx) และ [app/(app)/settings/superadmin/users/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/users/page.tsx), [components/app/stores-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stores-management.tsx) ใช้ `stores.*` keys แล้วสำหรับ current store summary, switch store/branch, create store sheet, branch-management board, branch-create wizard, validation, sharing summary, และ operator toasts, และ page shell/navigation ของ [app/(app)/settings/stores/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/stores/page.tsx), [app/(app)/settings/superadmin/stores/store-config/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/stores/store-config/page.tsx), และ [app/(app)/settings/superadmin/stores/branch-config/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/superadmin/stores/branch-config/page.tsx) ถูกแปลแล้ว พร้อม quota summary ที่ format ตาม locale ของผู้ใช้
- รอบล่าสุดของ legacy `system-admin` workspace ใน [app/(system-admin)/layout.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/layout.tsx), [app/(system-admin)/system-admin/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/page.tsx), [app/(system-admin)/system-admin/config/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/page.tsx), [app/(system-admin)/system-admin/config/system/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/system/page.tsx), [app/(system-admin)/system-admin/config/clients/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/clients/page.tsx), [app/(system-admin)/system-admin/config/stores-users/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/stores-users/page.tsx), [app/(system-admin)/system-admin/config/security/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/security/page.tsx), และ [components/system-admin/](/Users/csl-dev/Desktop/alex/csb-pos/components/system-admin) ถูกผูก `systemAdmin.*` keys แล้วสำหรับ layout/nav, dashboard, config cards, form labels/placeholders, success/error copy และ map known API messages ให้แสดงตาม locale ของผู้ใช้ผ่าน [lib/system-admin/i18n.ts](/Users/csl-dev/Desktop/alex/csb-pos/lib/system-admin/i18n.ts)
...
- หน้า [components/app/orders-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/orders-management.tsx) มีเมนู `3 จุด` เป็น secondary actions แล้วทั้ง mobile card และ desktop table โดยมี `เปิดรายละเอียด`, `พิมพ์ใบเสร็จ`, และ `พิมพ์สติ๊กเกอร์` (เฉพาะออเดอร์ออนไลน์); flow พิมพ์จากหน้า `/orders` ถูกปรับให้ fetch `GET /api/orders/[orderId]` แล้ว inline print ผ่าน helper กลาง [lib/orders/print-client.ts](/Users/csl-dev/Desktop/alex/csb-pos/lib/orders/print-client.ts) แบบเดียวกับหน้า detail/created-order success sheet แทนการเปิด print page แยก
- tab หลักบนหน้า `/orders` ถูกปรับ copy ให้ตรง mental model งานมากขึ้นแล้วเป็น `ทั้งหมด / รอดำเนินการ / กำลังทำ / ส่งแล้ว` โดยยังคงใช้ query keys เดิม (`ALL / PENDING_PAYMENT / PAID / SHIPPED`) เพื่อไม่ให้กระทบ URL/API
- หน้า [components/app/orders-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/orders-management.tsx) ถูก redesign เชิง hierarchy แล้วในโหมด manage: เพิ่ม queue summary strip จากข้อมูลแท็บปัจจุบัน, เปลี่ยน tabs เป็น pill cards ที่มีคำอธิบายสั้น, ทำ bulk action bar ให้เป็น workflow card ชัดขึ้น, ปรับ mobile cards ให้แยกชั้น `identity / status / work summary / quick eligibility`, และปรับ desktop table cells ให้ stack ข้อมูลสำคัญ (order no + date, customer + channel, payment/shipping meta, total + quick readiness)
...
- `lib/i18n/` key-based i18n foundation (`config`, `messages`, `translate`, `storefront`, `types`)
...
- i18n rollout phase 1:
  - migration [postgres/migrations/0010_user_language_preference.sql](/Users/csl-dev/Desktop/alex/csb-pos/postgres/migrations/0010_user_language_preference.sql) เพิ่ม `users.preferred_language`
  - session schema/query ถูกขยายให้คืน `language`
  - [app/api/settings/account/route.ts](/Users/csl-dev/Desktop/alex/csb-pos/app/api/settings/account/route.ts) รองรับ `PATCH action=update_language` และ `GET preferredLanguage`
  - เพิ่มหน้า [app/(app)/settings/language/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/settings/language/page.tsx) และ component [components/app/account-language-settings.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/account-language-settings.tsx)
  - [app/(app)/layout.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/layout.tsx), [components/app/app-top-nav.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/app-top-nav.tsx), และ [components/app/bottom-tab-nav.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/bottom-tab-nav.tsx) อ่านภาษาจาก app shell context แล้ว
...
- Orders:
  ...
  - UX `/orders/new`:
    ...
    - บนหน้า `/orders/new` เพิ่มปุ่ม `เมนู` ที่ top nav แล้ว โดยเปิด `SlideUpSheet` สำหรับ quick switch ไป `รายการขาย / สต็อก / สินค้า / รายงาน / ตั้งค่า`; ถ้ามี draft ค้างจะขึ้น confirm ก่อนล้าง draft แล้วออกจากหน้า
...
อัปเดต UX ล่าสุด:
- หน้า `/orders` ถูกปรับเป็น mobile-first compact แล้ว: page header เหลือแค่ `รายการขาย` + ปุ่ม COD/สร้างออเดอร์, component ภายในเหลือ action row + tabs, ซ่อน summary strip และ tab descriptions บน mobile, ใช้ tabs แบบ grid 4 ช่องในจอเดียวบน mobile, ใช้ sticky bottom bulk action bar เฉพาะตอนมี selection, และย่อ mobile order cards ให้เหลือข้อมูลที่จำเป็นต่อการคัดงานเร็ว
- รอบล่าสุดของ `/orders` เป็น visual polish only: tabs, badges, cards, desktop table, และ sticky bulk bar ถูกปรับ style ให้ modern/คมขึ้นโดยไม่เพิ่มพื้นที่ใช้งาน
- หน้า `/orders/cod-reconcile` ถูกย่อเป็น compact task UI แล้ว: ตัด summary cards และข้อความช่วยยาว ๆ ออก, ให้ summary chips แสดงเฉพาะตอนมี selection หรือมี input ผิด, ย่อฟอร์มต่อแถวเป็น grid 2 คอลัมน์ (`ควรได้ / ยอดที่โอนมา / ค่าธรรมเนียม / สุทธิหลังหักค่าธรรมเนียม`) เพื่อลดความสูงต่อรายการ, แสดงข้อความ `ขาด/เกินจากยอดที่ควรได้` แยกจากสุทธิ เพื่อไม่ให้สับสนกับค่าธรรมเนียม, แถวปิดยอดด้านล่างจะแสดงเฉพาะตอนมี selection พร้อม copy สั้น `ยืนยันปิดยอด`, ที่ filter bar มี quick date presets (`วันนี้ / เมื่อวาน / 7 วัน / 30 วัน`) ให้กดตั้งช่วงวันที่ทันทีได้แล้ว, และช่องวันที่ถูกเปลี่ยนจาก native `input type="date"` เป็น custom calendar picker แบบเดียวกับหน้าจัดซื้อ/stock history
- หน้า `/dashboard` ถูกปรับเป็น compact dashboard แล้ว: ลด hero แบบ decorative เดิมลงเป็น header สั้น + badge บทบาท, ใช้ KPI 4 ใบแบบคงที่ (`ยอดขายวันนี้ / ออเดอร์วันนี้ / รอชำระ / สินค้าใกล้หมด`) และคง task cards แค่ `สินค้าใกล้หมด` กับ `งานเจ้าหนี้ค้างชำระ`; ลิงก์ไปทำงานต่อถูกคงไว้เฉพาะใน card ที่เกี่ยวข้อง (`ไปหน้าสต็อก` / `ไปหน้า PO`) และไม่ใช้ quick action menu กลางหน้าแล้ว; layout ของ store type ต่าง ๆ (`ONLINE/CAFE/RESTAURANT/OTHER`) ใช้โครงเดียวกันแล้วและต่างกันเฉพาะโทนสี
- dashboard data เพิ่ม metric `pendingCodReconcileCount` แล้ว และหน้า `/dashboard` มี task card `COD รอปิดยอด` แบบ compact พร้อมลิงก์ไป `/orders/cod-reconcile`; card นี้แยกจาก KPI หลักเพื่อคงแถว KPI ให้คมและไม่รก และทางเข้า `ดูรายงาน` ถูกวางเป็นปุ่มรองขนาดเล็กเหนือแถว KPI เพื่อให้หา report เจอง่ายขึ้นโดยไม่ทำให้หน้าเหมือน menu hub
- หน้า `/reports` ถูก redesign เป็น `clean analytical layout` แล้วใน [app/(app)/reports/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/reports/page.tsx): มี header แบบ analytics, summary KPI 4 ใบ (`ยอดขายวันนี้ / ยอดขายเดือนนี้ / กำไรขั้นต้น / COD สุทธิสะสม`), section แบบ 2 คอลัมน์บน desktop และ stack บน mobile, พร้อม mini bar visuals สำหรับ `ยอดขายตามช่องทาง` และ `สินค้าขายดี` โดยยังใช้ data เดิมจาก [server/services/reports.service.ts](/Users/csl-dev/Desktop/alex/csb-pos/server/services/reports.service.ts) และยังไม่เพิ่ม date-range backend/filter จริงใน phase นี้
- i18n foundation (`lo / th / en`) พร้อมใช้แล้วผ่าน `lib/i18n/*`, session/app shell โหลด `users.preferred_language`, และหน้า `Settings > Language` ใช้เปลี่ยนภาษาได้จริง; scope ที่แปลแล้วตอนนี้คือ `shell + nav + settings language + dashboard + orders (manage + create flow) + stock shell/high-traffic surfaces`
- stock i18n rollout ล่าสุดครอบ [app/(app)/stock/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(app)/stock/page.tsx), [components/app/stock-tabs.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-tabs.tsx), [components/app/stock-tab-feedback.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-tab-feedback.tsx), [components/app/stock-inventory-view.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-inventory-view.tsx), [components/app/stock-recording-form.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-recording-form.tsx), [components/app/stock-movement-history.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-movement-history.tsx), และ shell ของ [components/app/purchase-order-list.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/purchase-order-list.tsx)
- legacy `system-admin` workspace ใช้ translator แล้วทั้ง layout/nav/dashboard/config/forms ใน [app/(system-admin)/layout.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/layout.tsx), [app/(system-admin)/system-admin/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/page.tsx), [app/(system-admin)/system-admin/config/page.tsx](/Users/csl-dev/Desktop/alex/csb-pos/app/(system-admin)/system-admin/config/page.tsx), และ [components/system-admin/](/Users/csl-dev/Desktop/alex/csb-pos/components/system-admin) โดยใช้ dictionary ชุด `systemAdmin.*` ใน [lib/i18n/messages.ts](/Users/csl-dev/Desktop/alex/csb-pos/lib/i18n/messages.ts)
- [components/app/stock-recording-form.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/stock-recording-form.tsx) ถูกเก็บ deep strings ของ operator flow แล้ว ทั้ง `search/load errors`, `quick presets`, `barcode feedback`, `permission/save toasts`, `guide/help box`, `purchase warning`, `labels/placeholders`, และ `base quantity preview`
- สิ่งที่ยังเหลือจริงของ i18n ตอนนี้คือ shortcut/default helper copy และ residual AP supplier/export surfaces บางส่วนใน [components/app/purchase-order-list.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/purchase-order-list.tsx), helper text/toasts บาง edge case ใน [components/app/products-management.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/products-management.tsx), และ residual hardcoded/API-sourced copy audit รอบสุดท้ายก่อนบังคับ rule ว่า string ใหม่ต้องออกผ่าน i18n key เท่านั้น
