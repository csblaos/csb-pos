...
- สิ่งที่ยังเหลือจริงในโดเมน stock คือ deep purchase/order-entry strings ใน [components/app/purchase-order-list.tsx](/Users/csl-dev/Desktop/alex/csb-pos/components/app/purchase-order-list.tsx); phase ถัดไปของ i18n ควรเก็บก้อนนี้ก่อนขยับไป products
